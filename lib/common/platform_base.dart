...
import 'package:mvvm_core_project/common/platform_helper.dart';
...
abstract class PlatformBaseWidget<A extends Widget, I extends Widget> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PlatformHelper.isMaterialApp() ? createMaterialWidget(context) : createCupertinoWidget(context);
  }
